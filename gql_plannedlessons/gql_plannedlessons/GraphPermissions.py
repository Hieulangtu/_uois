...
from gql_plannedlessons.DBDefinitions import BaseModel, UserModel, GroupModel, MembershipModel, RoleModel
from gql_plannedlessons.DBDefinitions import GroupTypeModel, RoleTypeModel
